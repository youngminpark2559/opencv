// cd /home/young/Desktop/git_ssh_opencv/opencv/jhkim/002_AboutMat_002_Mat_Basic_functions_copy_copyTo_clone_range_region_copy/003_use_clone_to_fully_copy_image && \
// g++ `pkg-config --cflags opencv` \
// -o main \
// /home/young/Desktop/git_ssh_opencv/opencv/jhkim/002_AboutMat_002_Mat_Basic_functions_copy_copyTo_clone_range_region_copy/003_use_clone_to_fully_copy_image/main.cpp \
...
int main()
{
  ...
  // ======================================================================
  // Fully copy img and assign copied one into img2
  Mat img2=img.clone();
  bitwise_not(img,img);
  imshow("img2",img2);
  waitKey(0);
