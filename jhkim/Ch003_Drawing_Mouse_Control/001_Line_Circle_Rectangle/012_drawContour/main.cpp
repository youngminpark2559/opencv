// cd /home/young/Desktop/git_ssh_opencv/opencv/jhkim/Ch003_Drawing_Mouse_Control/001_Line_Circle_Rectangle/012_drawContour && \
// g++ \
// -std=c++11 \
// `pkg-config --cflags opencv` \
// -o main \
// /home/young/Desktop/git_ssh_opencv/opencv/jhkim/Ch003_Drawing_Mouse_Control/001_Line_Circle_Rectangle/012_drawContour/main.cpp \
...
int main(int, char)
{
  ...
  // Rect rect_info=Rect(Point(40,40),Point(400,400));
  
  // rectangle(img,rect_info,Scalar(255,0,0),10);
  // // imshow("test",img);
  // // waitKey(0);
  ...
  // // c contour: Create vector instance whose elements are Point objects
  // vector<Point> contour;

  // // ======================================================================
  // // Push Point objects into vector contour
  ...
  // // ======================================================================
  // // c pts: point variable which stores address of Point object
  // // Create Mat object with passing vector contour and get data via .data
  // // And perform type cast to const cv::Point*
  ...
  // auto pts=(const cv::Point*)Mat(contour).data;
  // auto npts=Mat(contour).rows;
  ...
  // // ======================================================================
  // // c sc: size of contour
  // auto sc=contour.size();

  // // You draw polyline with for loop
  // for(int i=0;i<sc-1;++i)
  // {
  //   // c color_con: coloar of contour
  //   auto color_con=CV_RGB(255,0,0);
  //   line(img,contour[i],contour[i+1],color_con,2);
  // }
  // // imshow("test",img);
  // // waitKey(0);
  ...
  // // c ptss: Create array whose elements are Point objects
  // cv::Point ptss[4]; 
  ...
  // // ======================================================================
  // auto color=cv::Scalar(0,0,200);

  // // img: Mat type variable
  // // 4: number of units
  // cv::fillConvexPoly(img,ptss,4,color);
  // // imshow("test",img);
  // // waitKey(0);
  ...
  // // c TestStr: create array which will store char data
  // char TestStr[100];
  ...
  // // TestStr: string
  // // Point(10,250): x,y coordinates which stand for start position of string
  // // 1: value of scale
  // // Scalar(0,0,0): size of font
  // // 1: thinkness of font
  // // 1: type of font (line, dot, ...)
  // putText(img,TestStr,Point(10,250),CV_FONT_NORMAL,1,Scalar(0,0,0),1,1);
  // // imshow("show0",img);
  // // waitKey(0);
  ...
  // drawContour() draws multiple polygons, 
  // which is convinient way when you draw contours
  ...
  // ======================================================================
  // Convert color space of img (currently BRG) into GRAY
  // And save converted image into img (overwrite)
  cvtColor(img,img,CV_RGB2GRAY);
  // imshow("show1",img);
  // waitKey(0);

  // ======================================================================
  // If pixel value is larger than 128, it will become 255
  // otherwise, 0
  // CV_THRESH_BINARY: option
  threshold(img,img,128,255,CV_THRESH_BINARY);
  // imshow("threshhold",img);
  // waitKey(0);

  // ======================================================================
  auto rect_info=Rect(10,10,200,200);
  auto rect_line_color=CV_RGB(255, 255, 255);
  img.setTo(0);

  rectangle(img,rect_info,rect_line_color,CV_FILLED);
  // imshow("show1",img);
  // waitKey(0);

  // ======================================================================
  // c zero_arr: Create zero array
  auto zero_arr=Mat::zeros(img.rows,img.cols,CV_8UC3);

  // c dst: Create Mat instance
  Mat dst=zero_arr;
  // std::cout<<"dst: "<<dst<<std::endl;
  // [  0,   0,   0,   0,   0,...

  // ======================================================================
  // c contours: Create vector which stores vectors which store Point objects
  vector<vector<Point>> contours;

  // c hierarchy: Create vector which stores Vec4i objects
  vector<Vec4i> hierarchy;

  // ======================================================================
  // You can assume that there exist multiple chunks on a binary image
