// cd /home/young/Desktop/git_ssh_opencv/opencv/jhkim/002_AboutMat_002_Mat_Basic_functions_copy_copyTo_clone_range_region_copy/001_invert_image && \
// g++ `pkg-config --cflags opencv` \
// -o main \
// /home/young/Desktop/git_ssh_opencv/opencv/jhkim/002_AboutMat_002_Mat_Basic_functions_copy_copyTo_clone_range_region_copy/001_invert_image/main.cpp \
...
int main()
{
  ...
  // // =======================================================================
  // // Way of copying image into Mat
  // // =======================================================================

  // // =======================================================================
  // //      Using assignment operator (but NOT COPY BUT REFERENCE)
  // //      When img changes, img_s also changes
  // // =======================================================================

  // Mat img_s=img;
  // // You change original image
  // // bitwise_not(img,img);
  // imshow("img_s",img_s);
